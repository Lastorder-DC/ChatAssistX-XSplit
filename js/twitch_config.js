    ...
    window.addEventListener('polymer-ready', function()
    {
        ...
        xjs.ready()
            ...
            .then(function(item) {
                ...
                //var c!hatBoxColor = document.getElementsByName('c!hatbox')[0];
                //c!hatBoxColor.allowTransparent = true;
                ...
                var addComponentEventListeners = function() {
                    ...
                    //  ** color pickers
                    //  *******************************/
                    // c1hatBoxColor.addEventListener('change', function()
                    // {
                    //
                    // });

                    // c1hatBoxColor.addEventListener('set', function()
                    // {
                    //     configObj.boxColor = this.value;
                    //     setConfig();
                    // });

                    // c1hatBoxColor.addEventListener('reset', function()
                    // {
                    //
                    // });
                ...
                channelConnectButton.addEventListener('click', function()
                {
                    ...
                    req.onload = function()
                    {
                        ...
                        {
                            errorMessage.textContent = '트위치 채널을 찾을 수 없습니다';
                    ...
                    {
                        errorMessage.textContent = '인터넷 연결을 확인해주세요.';
                        errorMessage.parentNode.setAttribute('notfound', 'notfound');
                        resizeDisplaySection();
                    };
                ...
                var getSettings = function()
                {
                    ...
                    system.getFonts().then(function(fontArray) {
                        ...
                        .then(function(config) {
                            ...
                            // }
                            // c1hatBoxColor.value = configObj.boxColor;
                            enableChannelConfig();
